## IGSuite 4.0.0
## Procedure: SpreadsheetWriteExcelWorkbook.pm
...
use strict;
use Carp;
use IG::SpreadsheetWriteExcelBIFFwriter; ##XXXIG
use IG::SpreadsheetWriteExcelOLEwriter;  ##XXXIG
use IG::SpreadsheetWriteExcelWorksheet;  ##XXXIG
use IG::SpreadsheetWriteExcelFormat;     ##XXXIG
use IG::SpreadsheetWriteExcelChart;      ##XXXIG
use IG::SpreadsheetWriteExcelProperties; ##XXXIG

Spreadsheet::WriteExcel::Properties->import( ':property_sets' ); ##XXXIG
...
sub _get_checksum_method {
    ...
    eval "require Digest::Perl::MD4"; ##XXXIG
    if (not $@) {
